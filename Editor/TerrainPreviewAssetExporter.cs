...
static class TerrainPreviewAssetExporter
{
	...
	static void WriteSettingsSnapshot( string bundleDir, TerrainPreviewSettings settings, int iteration, string stem )
	{
		var snapshot = new
		{
			...
			settings.ShowPreviewDistanceRings,
			...
			settings.SpawnRequireLandEscape,
			settings.SpawnEscapeMinDistanceMeters,
			...
			settings.BiomeOverlayStrength01,
			settings.BiomeNoiseFrequency,
			settings.BiomeBoundaryNoiseFrequency,
			settings.BiomeDistanceWarpMeters,
			settings.BiomeWeightNoiseStrength01,
			settings.BiomeScatterOctaves,
			settings.BiomePickerOctaves,
			settings.BiomePickerFrequency,
			settings.BiomeDistanceInfluenceScale01,
			settings.BiomeSpeckFilterEnabled,
			settings.BiomeMinPatchDiameterMeters,
			settings.BiomeMountainMinHeight01,
			settings.BiomeAppearInnerRampPower,
			settings.BiomeCloverGuaranteeSpawn,
			settings.BiomeSpawnBlendEndMeters,
			settings.BiomeSpawnCloverBlendBoost01,
			settings.BiomeCloverRampFullDistanceMeters,
			settings.BiomeCloverAppearEndMeters,
			...
			settings.BiomeRedwoodHardMinDistanceMeters,
			settings.BiomeRedwoodRampFullDistanceMeters,
			settings.BiomeRedwoodAppearEndMeters,
			...
			settings.BiomeAmberHardMinDistanceMeters,
			settings.BiomeAmberRampFullDistanceMeters,
			settings.BiomeAmberAppearEndMeters,
